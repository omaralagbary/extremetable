...
public class DataSourcePopulator implements InitializingBean {
    ...
    public void afterPropertiesSet() throws Exception {
        jdbcTemplate.execute("CREATE TABLE presidents ( " 
                + " president_id    INTEGER NOT NULL PRIMARY KEY, " 
        ...
        jdbcTemplate.execute("INSERT INTO presidents(president_id, first_name, last_name, nick_name, term, born, died, education, career, political_party)"
