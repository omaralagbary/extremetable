A date filter that can be enabled in the properties file:

```
 table.filterRowsCallback.exactMatch=package.DateProcessRowsCallback
```

First the filterRowsCallback:
